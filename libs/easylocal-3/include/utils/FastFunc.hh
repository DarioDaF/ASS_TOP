...
public:
  template <class TThis, class TFunc>
  inline void bind(TThis *mThis, TFunc mFunc) noexcept { ptrThis = SimplifyMemFunc<sizeof(mFunc)>::convert(mThis, mFunc, ptrFunction); }
...
protected:
  template <class TThis, class TFunc>
  inline void bind(TThis *mThis, TFunc mFunc) noexcept { closure.bind(mThis, mFunc); }
  template <class TFunc>
  inline void bind(TFunc mFunc) noexcept { closure.bind(this, &FastFuncImpl::invokeStaticFunc, mFunc); }
...
public:
  ...
  inline FastFuncImpl(X *mThis, Y mFunc) noexcept { bind(mThis, mFunc); }
